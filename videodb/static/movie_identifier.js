...
IdentificationSession.prototype._renderMovie = function(movie) {
	...
	var img = new Element('img', {src: movie.cover || '/static/images/preview_unavailable.png'});
	
	img.addEvent('click', function() {
		//var _url = '/associate?imdbId='+movie.id+'&movieId='+this.identifyData.movieId;
		var _url = '/associate/'+this.identifyData.movieId+'/'+movie.id; //?imdbId='+movie.id+'&movieId='+this.identifyData.movieId;
